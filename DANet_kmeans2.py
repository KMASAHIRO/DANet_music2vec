...
from DANet_kmeans_module import generator_train2
from DANet_kmeans_module import square_root_of_hann
from DANet_kmeans_module import DANet
from DANet_kmeans_module import create_testdata2
...
weight_save_path = "DANet_music_kmeans2_weights.h5"
SDR_path = "evaluation2.txt"
before1_file = "kmeans2_long_before1.wav"
before2_file = "kmeans2_long_before2.wav"
input_data_file = "kmeans2_long_input_data.wav"
after1_file = "kmeans2_long_after1.wav"
after2_file = "kmeans2_long_after2.wav"
mixed_png = "kmeans2_long_mixed.png"
before1_png = "kmeans2_long_before1.png"
before2_png = "kmeans2_long_before2.png"
after1_png = "kmeans2_long_after1.png"
after2_png = "kmeans2_long_after2.png"
...
# 訓練データ作成に使うジェネレータの作成
Generator = generator_train2(noise_Fourier_list=noise_list[:1900], music_Fourier_list=music_list[:950], batch_size=30)
...
# テストデータでの推論
test_data, before_data = create_testdata2(noise_Fourier_list=noise_list[1900:],music_Fourier_list=music_list[950:])
